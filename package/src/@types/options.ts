...
type CompletePluginProps = {
    container: PluginPropsFunction<React.ComponentProps<"div">>;
    content: PluginPropsFunction<React.ComponentProps<"div">>;
    trackX: PluginPropsFunction<React.ComponentProps<"div">>;
    trackY: PluginPropsFunction<React.ComponentProps<"div">>;
    thumbX: PluginPropsFunction<React.ComponentProps<"div">>;
    thumbY: PluginPropsFunction<React.ComponentProps<"div">>;
};
